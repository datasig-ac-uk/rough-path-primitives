...
function(rpp_make_op_file_list _out)
    ...
    if (ARG_PRIMARY)
        ...
        set(_ops_prefix "${_prefix}")
    else ()
        set(_prefix "include/rpp/${ARG_PLATFORM}/${ARG_STRATEGY}")
        set(_ops_prefix "${_prefix}/operations")
    endif ()

    rpp_add_ops_cat(_working _missing linalg ${_ops_prefix} RPP_LINALG_OPS)
    rpp_add_ops_cat(_working _missing basic ${_ops_prefix} RPP_BASIC_OPS)
    rpp_add_ops_cat(_working _missing intermediate ${_ops_prefix} RPP_INTERMEDIATE_OPS)
