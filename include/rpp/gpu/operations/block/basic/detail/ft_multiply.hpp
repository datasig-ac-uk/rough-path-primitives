#ifndef RPP_GPU_OPERATIONS_BLOCK_BASIC_DETAIL_FT_MULTIPLY_HPP
#define RPP_GPU_OPERATIONS_BLOCK_BASIC_DETAIL_FT_MULTIPLY_HPP
...
#endif // RPP_GPU_OPERATIONS_BLOCK_BASIC_DETAIL_FT_MULTIPLY_HPP
