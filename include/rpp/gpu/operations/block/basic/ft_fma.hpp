#ifndef RPP_GPU_OPERATIONS_BLOCK_BASIC_FT_FMA_HPP
#define RPP_GPU_OPERATIONS_BLOCK_BASIC_FT_FMA_HPP
...
class FTFma<gpu::strategies::BlockStrategy<Accum_, BlockSize, Architecture>> : public BaseOperation<gpu::strategies::BlockStrategy<Accum_, BlockSize, Architecture>> {
...
template <typename BatchOut, typename BatchA, typename BatchB, typename BatchC, typename Basis, typename Accum_, unsigned MaxBlockSize, typename Architecture>
RPP_KERNEL void ft_fma_kernel(
...
#endif // RPP_GPU_OPERATIONS_BLOCK_BASIC_FT_FMA_HPP
