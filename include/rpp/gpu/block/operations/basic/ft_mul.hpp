#ifndef RPP_GPU_BLOCK_OPERATIONS_BASIC_FT_MUL_HPP
#define RPP_GPU_BLOCK_OPERATIONS_BASIC_FT_MUL_HPP
...
class FTMul<gpu::strategies::BlockStrategy<Accum_, BlockSize, MaxBlockSize, Architecture> > : public BaseOperation<
...
#endif // RPP_GPU_BLOCK_OPERATIONS_BASIC_FT_MUL_HPP