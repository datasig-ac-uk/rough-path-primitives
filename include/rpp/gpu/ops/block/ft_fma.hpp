#ifndef RPP_GPU_OPS_BLOCK_FT_FMA_HPP
#define RPP_GPU_OPS_BLOCK_FT_FMA_HPP
...
class FTFma<gpu::strategies::BlockStrategy<Accum_, BlockSize, Architecture>> {
...
RPP_KERNEL void ft_fma_kernel(
    ...
    op(
        ctx,
        batch_out.view(my_index, basis),
        batch_a.view(my_index, basis),
        batch_b.view(my_index, basis),
        batch_c.view(my_index, basis),
        alpha,
        beta
    );
}
...
#endif // RPP_GPU_OPS_BLOCK_FT_FMA_HPP
