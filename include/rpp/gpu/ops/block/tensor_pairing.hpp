#ifndef INCLUDE_RPP_GPU_OPS_BLOCK_TENSOR_PAIRING_HPP
#define INCLUDE_RPP_GPU_OPS_BLOCK_TENSOR_PAIRING_HPP
...
public:
    ...
    RPP_DEVICE void operator()(Context const& ctx, Scalar& out, const TensorFunc& functional, const TensorArg& arg) noexcept {
...
#endif //INCLUDE_RPP_GPU_OPS_BLOCK_TENSOR_PAIRING_HPP
