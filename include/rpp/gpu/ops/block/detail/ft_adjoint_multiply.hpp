#ifndef EXT_RPP_GPU_OPS_BLOCK_DETAIL_FT_ADJOINT_MULTIPLY_HPP
#define EXT_RPP_GPU_OPS_BLOCK_DETAIL_FT_ADJOINT_MULTIPLY_HPP
...
#endif // EXT_RPP_GPU_OPS_BLOCK_DETAIL_FT_ADJOINT_MULTIPLY_HPP
