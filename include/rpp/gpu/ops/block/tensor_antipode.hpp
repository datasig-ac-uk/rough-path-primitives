#ifndef RPP_GPU_OPS_BLOCK_TENSOR_ANTIPODE_HPP
#define RPP_GPU_OPS_BLOCK_TENSOR_ANTIPODE_HPP
...
class TensorAntipode<gpu::strategies::BlockStrategy<Accum_, BlockSize, Architecture>> {
...
public:
    ...
    RPP_DEVICE void operator()(Context const& ctx, TensorOut& out, TensorArg const& arg) const noexcept {
        gpu::block::generalised_antipode(ctx, out, arg, gpu::block::DefaultSigningPolicy{});
    }
};
...
#endif // RPP_GPU_OPS_BLOCK_TENSOR_ANTIPODE_HPP
