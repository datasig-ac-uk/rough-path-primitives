#ifndef RPP_GPU_OPS_BLOCK_ST_MUL_HPP
#define RPP_GPU_OPS_BLOCK_ST_MUL_HPP
...
class STMul<gpu::strategies::BlockStrategy<Accum_, BlockSize, Architecture>> {
...
#endif // RPP_GPU_OPS_BLOCK_ST_MUL_HPP
