...
constexpr auto make_lie_batch(Data&& data, Layout&& layout, BasisOrTag&& basis_or_tag, MinDegree min_degree, MaxDegree max_degree) noexcept {
    ...
    using Basis = std::conditional_t<is_basis_tag_v<BasisOrTag>, basis::LieBasis<traits::arch_of_t<Data>>, BasisOrTag>;
...
constexpr auto make_lie_batch(Data&& data, Layout&& layout, MinDegree min_degree, MaxDegree max_degree) noexcept {
    using RealLayout = std::conditional_t<std::is_integral_v<Layout>, layouts::StrideLayout<Layout>, Layout>;
