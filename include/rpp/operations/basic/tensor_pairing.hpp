...
template <typename Strategy,
          typename BatchOut,
          typename FunctionalBatch,
          typename ArgBatch,
          typename Basis>
auto tensor_pairing(Strategy const& strategy,
    ...
    static_assert(
        Op::is_implemented,
        "The operation object \"TensorPairing\" that implements "
        "\"tensor_pairing\" "
        ...
        "    #include "
        "<rpp/cpu/single_thread/operations/basic/tensor_pairing.hpp>");
