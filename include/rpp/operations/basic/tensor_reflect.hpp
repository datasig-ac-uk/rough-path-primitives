...
template <typename Strategy,
          ...
          typename BatchArg,
          typename Basis>
auto tensor_reflect(Strategy const& strategy,
    ...
    static_assert(
        Op::is_implemented,
        "The operation object \"TensorReflect\" that implements "
        "\"tensor_reflect\" "
        ...
        "    #include "
        "<rpp/cpu/single_thread/operations/basic/tensor_reflect.hpp>");
