...
namespace rpp::ops {
enum class TensorAntipodeSigningPolicy { NoSigning, SignByDegree };
...
public:
    ...
    void operator()(Context const& ctx,
        ...
        static_assert(
            ...
            "rpp::ops::TensorGeneralisedAntipode has no implementation for "
            "this Strategy. "
...
template <TensorAntipodeSigningPolicy Policy,
          typename Strategy,
          typename BatchOut,
          typename BatchArg,
          typename Basis>
auto tensor_generalised_antipode(
    ...
    static_assert(
        ...
        "    #include "
        "<rpp/cpu/single_thread/operations/basic/"
        "tensor_generalised_antipode.hpp>");
...
template <typename Strategy>
using TensorAntipode =
    TensorGeneralisedAntipode<Strategy,
                              TensorAntipodeSigningPolicy::SignByDegree>;

template <typename Strategy>
using TensorReflect =
    TensorGeneralisedAntipode<Strategy, TensorAntipodeSigningPolicy::NoSigning>;
