...
public:
    ...
    RPP_HOST_DEVICE void operator()(Context const& ctx,
        ...
        static_assert(static_assert_fail<Strategy,
                                         ...
                                         TensorC,
                                         Accum>,
                      "rpp::ops::FTInplaceFma has no implementation for this "
                      "Strategy/FMA type. "
...
using FTInplaceFma231 =
    FTInplaceFma<Strategy, FTInplaceFMAType::AEqualsBCPlusA>;

template <typename Strategy>
using FTInplaceFma123 =
    FTInplaceFma<Strategy, FTInplaceFMAType::AEqualsABPlusC>;

template <typename Strategy>
using FTInplaceFma213 =
    FTInplaceFma<Strategy, FTInplaceFMAType::AEqualsABPlusC>;

template <FTInplaceFMAType FMAType,
          typename Strategy,
          typename BatchA,
          typename BatchB,
          typename BatchC,
...
auto ft_inplace_fma(
    ...
    static_assert(
        Op::is_implemented,
        "The operation object \"FTInplaceFma\" that implements "
        "\"ft_inplace_fma\" "
        ...
        "    #include "
        "<rpp/cpu/single_thread/operations/basic/ft_inplace_fma.hpp>");
