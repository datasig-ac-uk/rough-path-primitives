...
template <typename Strategy,
          typename LieBatchOut,
          typename TensorBatchIn,
          typename Matrix,
          typename TensorBases,
          typename LieBasis>
auto tensor_to_lie(Strategy const& strategy,
    ...
    static_assert(
        Op::is_implemented,
        "The operation object \"TensorToLie\" that implements "
        "\"tensor_to_lie\" "
        ...
        "    #include "
        "<rpp/cpu/single_thread/operations/basic/tensor_to_lie.hpp>");
