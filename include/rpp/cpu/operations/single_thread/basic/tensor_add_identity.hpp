#ifndef RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_TENSOR_ADD_IDENTITY_HPP
#define RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_TENSOR_ADD_IDENTITY_HPP
...
#endif // RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_TENSOR_ADD_IDENTITY_HPP
