#ifndef RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_FT_FMA_HPP
#define RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_FT_FMA_HPP
...
#endif // RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_FT_FMA_HPP
