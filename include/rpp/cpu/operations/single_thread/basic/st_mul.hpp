#ifndef RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_ST_MUL_HPP
#define RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_ST_MUL_HPP
...
#endif // RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_ST_MUL_HPP
