#ifndef RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_ST_INPLACE_FMA_HPP
#define RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_ST_INPLACE_FMA_HPP
...
#endif // RPP_CPU_OPERATIONS_SINGLE_THREAD_BASIC_ST_INPLACE_FMA_HPP
