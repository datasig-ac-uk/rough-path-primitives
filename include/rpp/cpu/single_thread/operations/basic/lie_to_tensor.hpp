...
// class LieToTensor<cpu::strategies::SingleThreadStrategy<Accum_,
// Architecture_>, L2TImplementationType::CommutatorExpansion> {
//     using Strategy = cpu::strategies::SingleThreadStrategy<Accum_,
//     Architecture_>; using Accum = typename Strategy::Accum; using Index =
//     typename Strategy::Index; using Degree = typename Strategy::Degree;
//
// public:
...
//
//         for (Degree deg=std::max(1, arg.min_degree()); deg <=
//         arg.max_degree(); ++deg) {
