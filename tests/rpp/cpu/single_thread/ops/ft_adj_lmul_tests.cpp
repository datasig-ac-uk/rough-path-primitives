...
struct NumericAdjointLeftMulConfig {
...
class NumericFreeTensorAdjointLeftMulTests : public testing::Test {
protected:
...
using NumericAdjointLeftMulTestTypes = testing::Types<
    NumericAdjointLeftMulConfig<float, float>,
    NumericAdjointLeftMulConfig<double, double>>;

TYPED_TEST_SUITE(NumericFreeTensorAdjointLeftMulTests,
                 NumericAdjointLeftMulTestTypes);
...
TYPED_TEST(NumericFreeTensorAdjointLeftMulTests,
    ...
    auto const product = TestFixture::apply_left_product(basis, op, t);
...
TYPED_TEST(NumericFreeTensorAdjointLeftMulTests,
           LetterOperatorShiftsCoefficientsLeft) {
    auto const basis_data =
        typename TestFixture::BasisData(TestFixture::width, TestFixture::depth);
    auto const& basis = basis_data.basis;
