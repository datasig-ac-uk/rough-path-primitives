...
class ShuffleTensorInplaceFmaTests
    : public testing::Test,
      public Helper {
protected:
...
TEST_F(ShuffleTensorInplaceFmaTests, MatchesOutOfPlaceFmaWithScaledAddendAndProduct)
{
...
TEST_F(ShuffleTensorInplaceFmaTests, KernelWrapperMatchesDirectOperation)
{
    ...
    rpp::cpu::single_thread::st_inplace_fma_kernel(
